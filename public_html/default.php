...
<html>
    <head>
        <title>Välkommen till <? print $host; ?>!</title>
    ...
    <body>
        <div id="main">
            <div id="content">
                <div class="header">
                    <a id="logo" href="http://www.hostinger.se/"><img src="http://www.hostinger.se/images/logo-se.png" alt="Webbhotell" /></a>
                </div>
                <div class="content">
                    <h1>Ditt konto har nu skapats!</h1>
                    <p>Domänen <b><? print $host; ?></b> har installerats på vår server! Vänligen ta bort filen <b>default.php</b> från mappen <b>public_html</b> och ladda sedan upp din hemsida antingen genom att använda FTP eller Filahnteraren.</p>
                    <p>Här är en lista över dina filer i mappen public_html:</p>
                    <div id="files">
                        <div class="top"></div>
                        <div class="cont">
            ...
            <div id="footer">
                <div class="links">
                    <a href="http://www.hostinger.se/web-hosting" target="_blank">Webbhotell</a> 
                    <span class="pipe">|</span> 
                    <a href="http://www.hostinger.se/gratis-hosting" target="_blank">Gratis webbhotell</a> 
                    <span class="pipe">|</span> 
                    <a href="http://www.hostinger.se/forum" target="_blank">Support Forum</a> 
                    <span class="pipe">|</span> 
                    <a href="http://cpanel.hostinger.se/" target="_blank">Vänligen logga in</a>
                </div>
                <div class="copyright">Hostinger Sverige &copy; <? print date('Y'); ?>.</div>
                <div class="social-icons">
                    <a href="http://www.facebook.com/Hostinger.se"><img src="http://www.main-hosting.com/hostinger/welcome/images/fb.gif" /></a>
